//
//  JsonSerializerSwift.swift
//  NuevaBanca-ios
//
//  Created by Diego Perez Salas RSI on 09/03/2020.
//
        ...
        for (optionalPropertyName, value) in filteredChildren {
            ...
            if propertyName != nil && propertyName == "some" && property.displayStyle == Mirror.DisplayStyle.struct {
                ...
                for (index, value) in array.enumerated() {
                    handledValue += value != nil ? String(value!) : "var"
...
//                    null2
            ...
            if !skip {
                ...
                if let propertyName = propertyName {
                    if (handledValue != "null2"){
                        var valueStr =  "\"\(propertyName)\":\(handledValue)"
